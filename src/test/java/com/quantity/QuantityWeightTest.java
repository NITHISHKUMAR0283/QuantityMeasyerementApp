...
import com.quantity.QuantityMeasurementApp.QuantityWeight;
...
class QuantityWeightTest {
    ...
    void testEquality_GramToPound_EquivalentValue() {
        var q1 = new QuantityWeight(453.592, WeightUnit.GRAM);
        var q2 = new QuantityWeight(1.0, WeightUnit.POUND);
    ...
    void testEquality_WeightVsLength_Incompatible() {
        ...
        var l = new com.quantity.QuantityMeasurementApp.QuantityLength(1.0, com.quantity.QuantityMeasurementApp.LengthUnit.FEET);
    ...
    void testEquality_TransitiveProperty() {
        var q1 = new QuantityWeight(1.0, WeightUnit.KILOGRAM);
        var q2 = new QuantityWeight(1000.0, WeightUnit.GRAM);
        var q3 = new QuantityWeight(1.0, WeightUnit.KILOGRAM);
        assertTrue(q1.equals(q2));
    ...
    void testConversion_RoundTrip() {
        var q1 = new QuantityWeight(1.5, WeightUnit.KILOGRAM);
